...
- [Pipeline di progetto](#pipeline-di-progetto)
- [Passi preliminari](#passi-preliminari)
- [Creazione gruppo e repository su GitHub](#creazione-gruppo-e-repository-su-github)
  [- Comunicazione del gruppo](#comunicazione-del-gruppo)
...
- [Configurazione del repository su GitHub](#configurazione-del-repository-su-github)
  [- Creazione di un Personal Access Token e impostazione del Secret](#creazione-di-un-personal-access-token-e-impostazione-del-secret)
    - [Creazione del Personal Access Token](#creazione-del-personal-access-token)
    - [Impostazione del GitHub Secret](#impostazione-dei-github-secret)
...
- [Lavoro sul codice dell’applicazione](#lavoro-sul-codice-dellapplicazione)
- [Test automatici e Controlli di Qualità](#test-automatici-e-controlli-di-qualità)
- [Esecuzione immagine Docker](#esecuzione-immagine-docker)
...
![ExecuteDockerImage_1](./img/packageSettings.png)
...
![ExecuteDockerImage_1](./img/manageAccess.png).
...
![Clone button](img/cloneusingurl.jpeg)
